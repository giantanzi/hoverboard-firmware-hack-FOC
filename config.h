...
// Limitation settings
#define I_MOT_MAX       45              // [A] Maximum single motor current limit
...
#define DEFAULT_RATE                250   // 30.0f [-] lower value == slower rate [0, 32767] = [0.0, 2047.9375]. Do NOT make rate negative (>32767)
